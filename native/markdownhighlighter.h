// Copied verbatim from omacom-io/omawrite (MIT License), commit as of
// 2026-09. See ../THIRD_PARTY_NOTICES.md for attribution and license text.
// Not modified -- notehighlighter.cpp is the ompom-specific integration
// layer that attaches this to a TextEdit's document.
#pragma once
